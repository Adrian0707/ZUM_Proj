...
```{r}
df <- read.csv(
  file = "C:/Users/aniak/Documents/Studia/ZUM_Proj/winemag-data-130k-v2.csv",
  sep = ','
)
...
write.table(
  word_index,
  file = "C:/Users/aniak/Documents/Studia/ZUM_Proj/word_index_word2vec.txt"
)
```
...
```{r}
word2vec_dir = 'C:/Users/aniak/Documents/Studia/ZUM_Proj/vectors_word2vec'
...
write.table(
  embedding_matrix,
  file = "C:/Users/aniak/Documents/Studia/ZUM_Proj/embedding_matrix_word2vec.txt"
)
```
...
write.table(doc2vec, file="C:/Users/aniak/Documents/Studia/ZUM_Proj/doc2vec_word2vec_downloaded.txt")
