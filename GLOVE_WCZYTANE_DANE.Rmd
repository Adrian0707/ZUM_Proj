...
Dopisanie do wektorów wektoróW nie występujących obecnie ale występujących w description jako 
wektory zerowe 
...
words_missing_in_glove_T_cut_matrix <- matrix(0, length(words_missing_in_glove_T_cut), 50)
